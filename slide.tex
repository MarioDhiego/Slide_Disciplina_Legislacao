...
\subtitle{Dsiciplina: Legislação de Trânsito}
\institute{
    Coordenadoria de Recursos Humansos \\
...
\begin{itemize}
\item Você conhece a Lei nº 14.071/2020 – mais conhecida como Nova Lei de Trânsito?
\item Trata-se de uma lei proposta pelo Presidente Jair Bolsonaro, em 2019, que visava a fazer grandes mudanças no Código de Trânsito Brasileiro (CTB).
\end{itemize}
